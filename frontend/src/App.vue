...
const routeProjectId = ref<number | null>(null)
const newTitle = ref('')
...
async function openProject(id: number) { routeProjectId.value = id; history.replaceState({}, '', `?project=${id}`); await store.openProject(id) }
